...
train_text = open('./dataset/jsontocsv_train.csv', 'rb').read().decode(encoding='utf-8')
# train_text = open(path_to_train_file, 'rb').read().decode(encoding='utf-8')
test_text = open('./dataset/jsontocsv_test.csv', 'rb').read().decode(encoding='utf-8')
...
train_X = train_X.reshape(blocks_train, n_steps, 15).astype(float)
